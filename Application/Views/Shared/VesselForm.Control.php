...
<!--                <div class="form-group">
            ...
            <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input" data-bind="value: descrip" disabled="disabled"/>
                    </div>
                
                    <div class="form-group">
                        <label class="control-label"><span class="glyphicon glyphicon-list"></span> Ship Class</label>
                        <input type="text" class="form-control input" title="Ship Class" data-bind="value: shipclass" disabled="disabled"/>
                    </div>
                
                    <div class="form-group">
                        <label class="control-label"><span class="glyphicon glyphicon-list"></span> Penetration Type</label>
                        <input type="text" class="form-control input" title="Penetration Type" data-bind="value: pentype" disabled="disabled"/>
                    </div>
                
                    <div class="form-group">
                        <label class="control-label"><span class="glyphicon glyphicon-list"></span> Cement System</label>
                        <input type="text" class="form-control input" title="Cement System" data-bind="value: cementid" disabled="disabled"/>
                    </div>
                
                    <div class="form-group">
                        <label class="control-label"><span class="glyphicon glyphicon-list"></span> Fire Caulk</label>
                        <input type="text" class="form-control input" title="Cement System" data-bind="value: firecaulk" disabled="disabled"/>
                    </div>
