...
<!--                            </td>-->
                            ...
                            <td class="item-action item-files">
                                ...
                                <a href="#" id="btn-edit" class="btn-files-dialog btn-action btn btn-default" data-qbtxlineid="<?php echo $item->getQbtxlineid() ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                <?php if ($pictureHref !== "#"):?>
