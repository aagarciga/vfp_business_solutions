...
class BaseICPARM {
     ...
     * @param type $itmwhs
     * @param type $itemtype
     * @param type $itemorigin
     * @param type $equivitem
     * @param type $upccode
     * @param type $descrip
     * @param type $descrip1
     * @param type $descrip2
     * @param type $extdescrip
     * @param type $podescrip
     * @param type $podescrip1
     * @param type $hazardous
     * @param type $weight
     * @param type $mweight
     * @param type $masterqty
     * @param type $length
     * @param type $width
     * @param type $height
     * @param type $thick
     ...
     * @param type $costnet
     * @param type $costfact
     * @param type $cstfctdsc
     * @param type $costunit
     * @param type $costland
     * @param type $costavg
     * @param type $listprice
     * @param type $listprctl
     * @param type $price1
     * @param type $prfact1
     * @param type $prqty1
     * @param type $prcommi1
     ...
     * @param type $prqty6
     * @param type $prcommi6
     * @param type $saleprice
     * @param type $salenddte
     * @param type $pricefact
     * @param type $prifctdsc
     * @param type $lstprchg
     * @param type $pricecode
     * @param type $onhand
     * @param type $negonhand
     * @param type $onhandmax
     * @param type $committed
     * @param type $comtoship
     * @param type $rmaqty
     * @param type $onorder
     * @param type $onhandmin
     * @param type $reordqty
     * @param type $minordqty
     * @param type $stkenddte
     * @param type $bckordqty
     * @param type $vendno
     * @param type $venstkno
     * @param type $lstsaldte
     * @param type $lstbuydte
     * @param type $lstarvdte
     * @param type $frsbuydte
     * @param type $lsticdate
     * @param type $lsticbal
     * @param type $icdatectrl
     * @param type $taxable
     * @param type $taxrate
     * @param type $taxcode
     * @param type $imptaxid
     * @param type $imptaxrate
     * @param type $ptdqtysld
     * @param type $ptdsls
     * @param type $ptdcost
     * @param type $ytdqtysld
     * @param type $ytdsls
     * @param type $ytdcost
     * @param type $pyqtysld
     * @param type $pysls
     * @param type $pycost
     * @param type $ppyqtysld
     * @param type $ppysls
     * @param type $ppycost
     * @param type $glacctsal
     * @param type $glacctexp
     * @param type $glacctast
     * @param type $glacctsw
     * @param type $icserial
     * @param type $recptdqty
     * @param type $recytdqty
     * @param type $recptdsls
     * @param type $recytdsls
     * @param type $swptdqty
     * @param type $swytdqty
     * @param type $swptdsls
     * @param type $swytdsls
     * @param type $adjptdqty
     * @param type $adjytdqty
     * @param type $adjptdsls
     * @param type $adjytdsls
     * @param type $gptdqty
     * @param type $gytdqty
     * @param type $gptdsls
     * @param type $gytdsls
     ...
     * @param type $rmytdsls
     * @param type $onbond
     * @param type $picture_fi
     * @param type $man_code
     * @param type $metric
     * @param type $catpageno
     * @param type $facttreat
     * @param type $masterd
     * @param type $metricd
     * @param type $bmisc
     * @param type $deactive
     ...
     * @param type $type6
     * @param type $locno
     * @param type $cstloadfct
     * @param type $costload
     * @param type $oldonhand
     * @param type $oldohdate
     * @param type $glacctwip
     * @param type $glacctswcs
     * @param type $custfld9
     * @param type $spclflag
     * @param type $reswhs
     * @param type $webdescrip
     * @param type $websyncflg
     * @param type $webactive
     * @param type $usdasdsc
     * @param type $vendor
     * @param type $kit
     * @param type $model
     * @param type $tagtype
     * @param type $rllupdate
     * @param type $fupdtime
     * @param type $fupddate
     * @param type $fstation
     * @param type $fuserid
     * @param type $pricecore1
     * @param type $pricecore2
     * @param type $pricecore3
     * @param type $pricecore4
     * @param type $pricecore5
     * @param type $pricecore6
     * @param type $notegen
     * @param type $corebase
     * @param type $corenet
     * @param type $coreunit
     * @param type $listcore
     * @param type $landcstdte
     * @param type $leadtime
     * @param type $swcogsflag
     * @param type $palqtysqf
     * @param type $palqtypcs
     * @param type $brdqtysqf
     * @param type $comper2
     * @param type $comr1f
     * @param type $comr2f
     * @param type $comr1t
     ...
     * @param type $abccode
     * @param type $designer
     * @param type $rettrxcode
     * @param type $prototype
     * @param type $inspection
     * @param type $stndcstdte
     * @param type $coststnd
     * @param type $onconsign
     * @param type $onconsignp
     * @param type $intran
     ...
     * @param type $etadays
     * @param type $introend
     * @param type $introcode
     * @param type $introdate
     * @param type $designnam
     * @param type $pcslayers
     * @param type $nolayers
     * @param type $qtyscrap
     * @param type $qblistid
     * @param type $blockdates
     * @param type $blockdatee
     * @param type $minmaxdate
     * @param type $fetamt
     * @param type $picnoupd
     * @param type $upccodein
     * @param type $caselength
     * @param type $casewidth
     * @param type $caseheight
     * @param type $countryorg
     * @param type $discamt
     * @param type $uncode
     * @param type $botldep
     * @param type $costhi6mth
     * @param type $mm_code
     * @param type $costgstbd
     * @param type $buyercode
     * @param type $shpcartid
     * @param type $icstat
     */
