...
class BootstrapPager extends Pager {
    ...
    public function paginate($page = 1,$handlerURL = "") {
    ...
    public function ajaxPaginate($page = 1) {
        ...
        if ($this->pagesCount > $this->showPagerControlsIfMoreThan) { // if more than ten pages
            // render previous link
            if ($this->currentPage != 1 And $this->getItemsCount() >= 10) {
                $this->pagerControl .= "<li><a href=\"#\" data-page=\"$prev_page\" data-ipp=\"$this->itemsPerPage\">&laquo;</a></li>";
            } else {
                $this->pagerControl .= "<li class=\"disabled\"><a href=\"#\" data-page=\"$prev_page\" data-ipp=\"$this->itemsPerPage\">&laquo;</a></li>";
            }
            ...
            for ($i = 1; $i <= $this->pagesCount; $i++) {
                ...
                if ($i == 1 OR $i == $this->pagesCount OR in_array($i, $this->range)) {
                    if ($i == $this->currentPage) {
                        ...
                        $this->pagerControl .= "<li><a href=\"#\" data-page=\"$i\" data-ipp=\"$this->itemsPerPage\" title=\"Go to page $i of $this->pagesCount\">$i</a></li>";
                    }
                }
            ...
            if ($this->currentPage != $this->pagesCount And $this->getItemsCount() >= 10) {
                $this->pagerControl .= "<li><a href=\"#\" data-page=\"$next_page\" data-ipp=\"$this->itemsPerPage\">&raquo;</a></li>";
            } else {
                $this->pagerControl .= "<li class=\"disabled\"><a href=\"#\">&raquo;</a></li>";
            }
        }
