/**
 * @author Alex
 * @namespace App.EquipmentHistoryDashboard.DynamicFilter
 * @param {window} global
 * @param {jQuery} $
 * @param {Object} App
 * @returns {undefined}
...
(function (global, $, App) {
    ...
    var dandelion = global.dandelion,
        DynamicFilter = dandelion.namespace('App.EquipmentHistoryDashboard.DynamicFilter', global);
    ...
    DynamicFilter.htmlBindings.filterFieldsContainer           = '.form-filter-container';
    ...
    DynamicFilter.functions.filter = function () {
        App.EquipmentHistoryDashboard.functions.paginate();
    };
    DynamicFilter.functions.loadFilter = function (filterId, filter) {
        $.ajax({
            ...
            url: App.EquipmentHistoryDashboard.urls.getSavedFilter,
            type: 'post',
            beforeSend: function () {
                $('.loading').show();
            },
    ...
    DynamicFilter.eventHandlers.drpSavedFilterItem_btnDelete_onClick = function (event) {
        ...
        $.ajax({
            ...
            url: App.EquipmentHistoryDashboard.urls.deleteFilter,
            type: 'post',
            beforeSend: function () {
                $('.loading').show();
            },
    ...
    DynamicFilter.eventHandlers.filterFields_btnAdd_onClick = function (event) {
        ...
        if (fieldType === 'text') {
            ...
            dropdownValues = global.App.EquipmentHistoryDashboard.dictionaries[$button.data('field-collection')];
    ...
    DynamicFilter.eventHandlers.modalSaveFilter_btnSave_onClick = function () {
        ...
        if (filterName !== "" && /\w/.test(filterName)) {
            $.ajax({
                ...
                url: App.EquipmentHistoryDashboard.urls.saveFilter,
                type: 'post',
                beforeSend: function () {
                    $('.loading').show();
                },
