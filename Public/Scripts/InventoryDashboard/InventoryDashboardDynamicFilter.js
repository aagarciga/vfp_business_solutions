/**
 * @author Alex
 * @namespace App.InventoryDashboard.DynamicFilter
 * @param {window} global
 * @param {jQuery} $
 * @param {Object} App
 * @returns {undefined}
...
(function (global, $, App) {
    ...
    var dandelion = global.dandelion,
        DynamicFilter = dandelion.namespace('App.InventoryDashboard.DynamicFilter', global);
    ...
    DynamicFilter.functions.filter = function () {
        App.InventoryDashboard.functions.paginate();
    };
    DynamicFilter.functions.loadFilter = function (filterId) {
        $.ajax({
            ...
            url: App.InventoryDashboard.urls.getSavedFilter,
            type: 'post',
            beforeSend: function () {
                $('.loading').show();
            },
    ...
    DynamicFilter.eventHandlers.drpSavedFilterItem_btnDelete_onClick = function (event) {
        ...
        $.ajax({
            ...
            url: App.InventoryDashboard.urls.deleteFilter,
            type: 'post',
            beforeSend: function () {
                $('.loading').show();
            },
    ...
    DynamicFilter.eventHandlers.filterFields_btnAdd_onClick = function (event) {
        ...
        if (fieldType === 'text') {
            ...
            dropdownValues = global.App.InventoryDashboard.dictionaries[$button.data('field-collection')];
    ...
    DynamicFilter.eventHandlers.modalSaveFilter_btnSave_onClick = function () {
        ...
        if (filterName !== "" && /\w/.test(filterName)) {
            $.ajax({
                ...
                url: App.InventoryDashboard.urls.saveFilter,
                type: 'post',
                beforeSend: function () {
                    $('.loading').show();
                },
